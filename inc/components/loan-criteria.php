  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-12 col-lg-6 text-center order-1 order-lg-2 mb-4 mb-lg-0 px-0 px-lg-3">
        <img src="<?php echo DIRECTORY; ?>/assets/images/image-loan-criteria-woman.png" alt="Woman with curly hair wearing a colourful necklace thinking while smiling" class="img-fluid">
      </div>
    </div>
  </div>
</section>

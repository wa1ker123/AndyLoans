<form id="loan-calculator" class="app-form loan-calculator my-md-2 my-sm-0 my-lg-4 px-3 max-x-700 mx-auto" autocomplete="on" oninput="formUpdate()" method="GET" action="<?php echo APPLICATION_URL ?>">
  ...
  <div class="row py-4">
    <div class="col-12 position-relative">
      ...
      <input type="range" name="amount" aria-label="Loan Amount" id="loan-amount" value="<?php echo LOAN_DEFAULT_VALUE ?>" min="<?php echo LOAN_MIN; ?>" max="<?php echo LOAN_MAX; ?>" step="<?php echo LOAN_AMOUNT_STEP; ?>">
    </div>

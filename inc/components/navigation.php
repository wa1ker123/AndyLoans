...
<nav class="navbar navbar-expand-lg">
  <div class="container-fluid px-0 px-lg-5 my-2 d-flex flex-row justify-content-between">
    <a href="<?php echo get_site_url(); ?>"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/logo-andy-loans.png" id="site-logo" alt="Andy Loans logo" class="img-fluid"></a>
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
      <nav class="stroke">
        <ul class="navbar-nav main-bg">
          ...
          <li><a class="color--black mx-3 px-2 py-2" href="<?php echo get_site_url(); ?>/about-us/">About Us</a></li>
...
<div id="sidenav" class="sidenav text-center background--black">
  <img src="<?php echo get_template_directory_uri(); ?>/assets/images/logo-andy-loans.png" class="img-fluid mb-5" alt="Andy Loans logo" style="width:10rem;">
  <ul class="pl-0">
